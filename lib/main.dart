    ...
    for (BluetoothService service in services) {
      ...
      for (BluetoothCharacteristic characteristic in characteristics) {
        if (characteristic.uuid.toString() ==
          ...
          // Set the notification for the specific characteristic
          await characteristic.setNotifyValue(true);

          // Write data to another characteristic if needed
          List<int> dataToWrite = [49]; // Modify this as needed
          await characteristic.write(dataToWrite);

          // Listen for notifications
          characteristic.onValueReceived.listen((value) {
            // Handle received values here
